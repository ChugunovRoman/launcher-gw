<script lang="ts">
  let { size = $bindable(24), color = $bindable("#FFF") } = $props();
</script>

<svg class="spinner" fill={color} style="width: {size}px; height: {size}px" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"
  ><path
    class="fil0"
