...
pub fn register_handlers(app: Builder<Wry>) -> Builder<Wry> {
  app.invoke_handler(tauri::generate_handler![
    ...
    handlers::faction_settings::fe_is_game_running,
    handlers::faction_settings::fe_export_bundle,
    ...
    handlers::faction_settings::fe_profile_inspect,
    handlers::faction_settings::fe_profile_export,
    handlers::faction_settings::fe_profile_import,
    handlers::faction_settings::fe_profile_update_meta,
    handlers::faction_settings::fe_profile_delete,
    handlers::faction_settings::fe_profiles_dir,
    handlers::faction_settings::fe_set_version,
    // compress
