...
pub fn register_handlers(app: Builder<Wry>) -> Builder<Wry> {
  app.invoke_handler(tauri::generate_handler![
    ...
    handlers::service::preview_index,
    handlers::service::commit_index,
    handlers::service::republish_index_force,
    handlers::service::get_unpublished_releases,
    // releases
    ...
    handlers::verify_install::verify_installed_version,
    handlers::verify_install::cancel_verify_installed_version,
    handlers::verify_install::start_repair_version,
    handlers::release::get_available_versions,
    handlers::release::refresh_available_versions,
    ...
    handlers::release::get_release_assets_sha,
